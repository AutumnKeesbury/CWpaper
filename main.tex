...
\title{Generalizing the Bullet: The Transformation of American Medicine during the Civil War}
...
reports, and other \textit{miscellanea bibliorum}. Although my aim here is not to provide a comprehensive history of the Sanitary Commission, though
...
and administrative functions in a manner somewhat akin to the modern American Red Cross or the \textit{Médecins Sans Frontières}, the Commission began to
...
With all of this considered, what I wish to accomplish with this paper is to demonstrate that the Civil War marked a great shift in American medicine. I will attempt
...
finally, I will argue that the result of these changes was the rapid development of a normative medicine which penetrated all the aspects of life which formerly were
passed over by the medical gaze.
...
only when they presented an ailment or injury too severe for a family member, often a mother or wife, to tend to. Although formal training did exist, many town
...
gaze, with the patient simply being a vessel for the interaction of constitutions and afflictions, and the role of the doctor being then
...
United States between 1861 and '65. This portrayal is obviously an oversimplification, but I believe that there is great insight to be found
in studying at least the evolution of medical institutions during the War through this lens. Indeed, when understood as institutional responses to epidemics,
...
viewpoint which, by virtue of its ability to provide far-reaching insights, served as the impetus for this paper.
...
reorganization of one institution is accompanied by a similar reorganization of the other. In this sense, the medical gaze forms a negative
...
There is no better example of this totalizing gaze than the camp inspection. Conducted by the Sanitary Commission, these inspections were far from
strictly 'medical', and in this aspect do well to demonstrate the great expansion of the domain of medicine. The choice
of camp inspection return form to examine is somewhat arbitrary, as they all list the same questions for the inspector to answer, so I will be looking
at one performed on the camp of the 21\textsuperscript{st} Ohio Volunteer Infantry Regiment at Camp Jefferson, KY, on 9 January 1862.\autocite{ussc:20:699}
...
This gaze, in being both disciplinary and medical, was able to do something much more profound than simply maintaining order and health in the army: it was
...
At the same time as the restructuring of the sanitary gaze just explored, a much more physical space was undergoing a transformation of a no less
...
similarities are not mere happenstance, but rather spawn from, and are indicative of, a systematic coincidences in the goals of disciplinary institutions and the
medical institutions of the Civil War.
...
forms a collection of completely knowable sets, the union of which is not the original unstructured mass, but rather a table,
as suggested by Figure \ref{fig:ward}. In brief, a topology generated by an induced metric makes possible, through the very essence
of the ward, a space which unifies the meticulous observation of the doctor with the language of his perception: the emergence of the clinic.\autocite[113]{Foucault1994}
...
The general hospital, then, was a panoptic construction, built with the express intention of a surveillance both constant and minimal by the
...
during the Civil War, the once strictly remedial gaze of the surgeon, the doctor, and the pharmacist came to take up a normative character.
...
The work of the doctor, then, becomes not to treat according to the multitude of symptoms and the temperament of the patient, but to remove them, as far as possible,
from consideration. This is a form of the disciplinary method described by Foucault as such: \say{The examination, surrounded by all its documentary
...
\autocite[191]{Foucault1995}. In removing as much specificity as possible, the true essence of the affliction is discovered as a sort of average of cases. In order
...
reference to injury of the knee joint, \say{the history of one of these cases}, he remarks, \say{is the history of all}. Dr. Russell
...
amputation in such cases, as Russell notes that, when the surgeons did finally amputate the patient's leg, they did so \say{without in any way improving the
	chance of recovery}.\autocite[All quoted portions of this paragraph appear in][33]{ussc:2:194}
...
of data, a whole series of patterns which were formerly obscured by small sample-sizes now came into a sharper focus than was formerly possible. These data, however,
...
\subsection{"Case 7th, a Soldier, name unknown"} Let us return to Russell's report on the Battle of Prairie Grove, specifically his notes on amputations of the
thigh.\autocite[21]{ussc:2:194} These notes are typical for a report presented to the Sanitary Commission, with Russell beginning the section with the statement
that \say{there have been 23 amputations of the thigh}, and proceeds to enumerate the history of each of said twenty-three cases.\autocite[21]{ussc:2:194}
Indeed, the format of these notes is so generic that any researcher at all acquainted with this type of source should feel very much at home in the pages
of Russell's report. Yet one entry, itself not atypical to those familiar, stuck out to me. It is brief enough that it may be reproduced in its entirety:

\begin{quote}
	Case 7\textsuperscript{th}, a Soldier, name unknown wounded Dec 7\textsuperscript{th} by a conical ball. Had extensive fracture of the left femur. Dr. Roap
	amputated the thigh at the junction of the upper and middle third. Dec 11\textsuperscript{th} --- Patient gradually failed from the date of the operation and died
	Dec 13\textsuperscript{th}.\autocite[25]{ussc:2:194}
\end{quote}

These few sentences, occupying only seven lines in Russell's handwriting and even fewer on this page, are perhaps the most extensive documentation of this man's
life which ever existed. Indeed, myself and the reader of this paper may be the only people who have thought so extensively about his life and his death, and their
meaning, in the current century. I do not, however, bring this up in order to wax poetic about the fleeting nature of life and one's memory. Rather, I am reminded
of Foucault's words, \say{[a]ll those lives destined to pass beneath any discourse and disappear without ever having been told were able to leave traces -- brief,
	incisive, often enigmatic -- only at the point of their instantaneous contact with power.}\autocite[161]{foucault2019} Foucault spoke here of a much more
straightforward and disciplinary power, yet I cannot shake the feeling of relevance.

For although we have so little of this man, even lacking his name, we do have \textit{something} of him. What we have is, very plainly, a case: through the
documentary techniques which had begun to emerge in the United States during the mid nineteenth-century, we are left with \say{traces} of this man and so many
others like him. Indeed, this is in sharp contrast to how, \say{[f]or a long time ... [t]o be
	looked at, observed, described in detail, followed from day to day by an uninterrupted writing was a privilege.}\autocite[191]{Foucault1995}
While obviously somewhat limited by the techniques of identification for individuals in the 1860s, what we are seeing in \say{Case 7\textsuperscript{th},
	a Soldier, name unknown} are the beginnings of a medical field in which, through interacting with the classificatory and individualizing gaze of the
doctor, no matter how briefly, the patient became forever the subject of disciplinary power. Here, then, are we to find the roots of a medical panopticism.

\renewcommand{\thesec}{Conclusion}
\section{\thesec}
