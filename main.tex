...
documentary techniques which begun to emerge in the United States during the mid nineteenth-century, we are left with \say{traces} of this man and so many
others like him. As is put so eloquently by Foucault, \say{[f]or a long time ordinary individuality ... remained below the threshold of description. To be
...
\subsection{Bodies alive and dead} I wish to conclude with a discussion of an aspect of many of the case histories present in the records of the USSC, but which
I did not find particularly relevant when first conducting research for this paper: the autopsy.

The place of death in medicine prior to the nineteenth century had always been a somewhat awkward one. Though the motivation of remedial care has long been to
push back, as far as possible, the death of the patient, and in this way the presence of death has been constant and immobile, it has always been so only
in an implicit, strictly negative fashion. It remained the spectre, looming over the shoulder of the doctor, always visible, but the role of death was manifested,
primarily, in the relationship between the it and the patient. Indeed, neither Wallis nor Yates present a treatment, philosophical or otherwise, of the subject of
death, despite its relevance to the subject of their works. This is to say that, since Hippocrates, the role of the physician always begun with the disease,
and ended with death --- only incidentally, then, did death show its bony face.
